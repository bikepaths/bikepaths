            ...
            <div class="row">
                <div class="col-sm-6" id="editor-col">
                    <div>
                        ...
                        <textarea id="wmd-input" class="form-control wmd-input <?php if (isset($postContent)) { if (empty($postContent)) { echo 'error'; } } ?>" name="content" cols="20" rows="100"><?php if (isset($postContent)) { echo $postContent;} ?></textarea><br>
                        <?php if(!empty($fields)):?>
